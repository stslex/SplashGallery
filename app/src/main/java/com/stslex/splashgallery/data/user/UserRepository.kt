...
interface UserRepository {
    ...
    suspend fun getUser(username: String): Flow<com.stslex.core.Resource<RemoteUserModel>>
    ...
    class Base @Inject constructor(
        ...
        override suspend fun getUser(username: String): Flow<com.stslex.core.Resource<RemoteUserModel>> =
