...
import com.stslex.splashgallery.data.model.data.*
import com.stslex.splashgallery.data.model.response.collection.RemoteCollectionModel
import com.stslex.splashgallery.data.model.response.collection.RemoteLinksCollectionModel
...
import com.stslex.splashgallery.data.model.data.image.*
import com.stslex.splashgallery.data.model.data.collection.LinksCollectionModel
import com.stslex.splashgallery.data.model.data.topics.PreviewPhotosModel
import com.stslex.splashgallery.data.model.data.topics.TopicsModel
import com.stslex.splashgallery.data.model.data.user.BadgeModel
import com.stslex.splashgallery.data.model.data.user.ProfileImageModel
import com.stslex.splashgallery.data.model.data.user.UserLinksModel
